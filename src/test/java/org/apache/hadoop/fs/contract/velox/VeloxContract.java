...
package org.apache.hadoop.fs.contract.velox;
 ...
 */
public class VeloxContract extends AbstractFSContract {

  public static final String CONTRACT_XML = "localfs.xml";
  ...
  public VeloxContract(Configuration conf) {
    super(conf);
